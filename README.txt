...
网站开发所用技术文档和需要install的插件回在requirements.txt中，我会在后期添加
linux开发环境下可以非常方便的直接sudo pip install requirements.txt就可以安装所需要的组件
建议python django开发者使用linux系统，pyhton和django开发者使用的OS操作系统django官网上有统计，linux系统是占比绝大多数的系统


.开发说明:
	本网站使用python语言开发，使用django框架，结合grappli，fontawesome相应模块
	网站资源来源于网络，网站用于python，django，linux，github，html，css，github等程序开发的学习交流。
	开发目的不在于商业应用，开发服务于互联网学习交流，网站借鉴使用warpbootstrap开发的unify框架，在此一并致敬。
	保留开发者相应权益，使用请声明。
	contributors：limodou大师不厌其烦的指点（python大牛，可爱的python，uliweb，ulipad原作者）
...
.网站待优化部分：
	网站开发像上帝造人一般，力求完美完善，但是凡人能力有限，专长有短，不完美之处在所难免.
	会者不难，难者不会。希望能给大家启迪，也期待高手指点不优雅的地方，技术进步就是不断曾删改查优化丰富的过程。
	个人愚见有待优化部分如下：
...
├── unify.html--网站主页
├── unifylayout.html--网站所有页面继承的页面模板，include了right_siderbar,newstudent模板
...
. CSS引用方面：
	1.由于本网站使用了bootstrap相应比较新的架构fontawesome，在国内没有相应的cdn库支持，所以只能在CSS导入时加入国外网站链接，翻墙问题不可避免
	...
	2.fontawesome在firefox浏览器上不支持，开发者解决模式由2种：
...
.技术亮点分享：
	1,页面清新美观，使用python语言django框架开发，简单易用，各个功能模块新潮
